...
def script_examples():
    ...
    \n- GetSetPowerStateREDFISH.py -ip 192.168.0.120 -u root -p calvin --set ForceOff, this example will set server power state to ForceOff.
    \n- GetSetPowerStateREDFISH.py -ip 192.168.0.120 -u root -p calvin --set On --ssl true, this example will set server power state to On.
...
#python3 PowerState.py -ip 10.2.161.103 -u root -p calvin --get
#python3 PowerState.py -ip 10.2.254.119 -u root -p calvin --set ForceOff
#python3 PowerState.py -ip 10.2.254.119 -u root -p calvin --set On
